...
export function SourceCitation({ sources }: SourceCitationProps) {
  ...
  return (
    <div className="my-10 bg-slate-50 border border-slate-100 rounded-[24px] p-6 md:p-8">
      <div className="flex items-center gap-2.5 mb-4">
        <FileText className="w-4 h-4 text-slate-500" />
        <h4 className="font-display font-bold text-sm text-slate-700 uppercase tracking-wider">Sources & References</h4>
      </div>
