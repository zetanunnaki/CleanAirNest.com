...
<AffiliateButton productId="airthings-view-plus" label="Start Monitoring Radon Now" />
...
<InternalLinks title="Continue Reading" links={[
  ...
  { title: "Best Radon Detectors for Home", href: "/best-picks/best-radon-detectors", description: "Top radon detectors ranked by accuracy and value" },
  { title: "Airthings View Plus Review", href: "/reviews/airthings-view-plus-review", description: "Best continuous radon monitor with multi-sensor tracking" }
]} />
