...
<AffiliateButton productId="coway-airmega-ap1512hh" label="Get the Easiest-to-Maintain Purifier" />
...
<InternalLinks title="Continue Reading" links={[
  ...
  { title: "Air Purifier Noise Levels Explained", href: "/guides/air-purifier-noise-levels-explained", description: "Understanding decibel ratings and quiet operation" }
]} />
