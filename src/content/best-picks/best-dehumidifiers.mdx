...
3. **Built-in pump (continuous):** The pump pushes water vertically through a smaller drain line. Ideal for basements where the drain is at or above the dehumidifier level. The Frigidaire and Hisense include pumps; for other models, you can buy an external condensate pump for $30-$50.
