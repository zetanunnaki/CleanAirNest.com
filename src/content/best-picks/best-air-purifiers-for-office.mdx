...
<InternalLinks title="Related Reading" links={[
  ...
  { title: "Air Purifier Noise Levels Explained", href: "/guides/air-purifier-noise-levels-explained", description: "Finding quiet purifiers that will not disturb your focus" }
]} />
