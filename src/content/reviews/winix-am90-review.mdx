...
<VerdictBox 
  verdict="The Winix AM90 is the best value in Wi-Fi-connected air purifiers. It takes the proven filtration performance of the beloved 5500-2 and adds reliable smart features, a better-looking design, and voice assistant support for a modest price increase."
  product="Winix AM90 Wi-Fi Air Purifier"
  rating="4.5"
  pros={["Wi-Fi with Alexa and Google support at under $200", "Same strong CADR as the 5500-2", "Smart auto mode with air quality sensor", "PlasmaWave can be toggled off"]}
