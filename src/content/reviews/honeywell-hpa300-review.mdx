...
<SpecTable specs={[
  {label: "Room Coverage", value: "465 sq. ft."},
  {label: "Filter Type", value: "True HEPA + Carbon Pre-filter"},
  {label: "CADR", value: "300 Smoke / 320 Dust / 300 Pollen"},
  {label: "Noise Level", value: "Variable"},
...
<VerdictBox 
  verdict="The Honeywell HPA300 is a capable workhorse with strong air cleaning performance. Its high CADR ratings and Turbo Clean mode make it effective for large rooms and acute air quality events."
  product="Honeywell HPA300 HEPA Air Purifier"
  rating="4.4"
  pros={["Turbo clean mode for quick purification", "Strong CADR ratings", "Trusted brand with long track record", "Captures up to 99.97% of particles"]}
  cons={["Louder than competitors on high", "No smart features", "Filter costs add up"]}
/>
