...
<VerdictBox 
  ...
  rating="4.5"
  pros={["Powerful 50-pint capacity", "Built-in pump for continuous drain", "Energy Star certified", "Easy-to-clean washable filter"]}
...
<InternalLinks title="Related Reading" links={[
  ...
  { title: "Frigidaire vs. GE Dehumidifier", href: "/guides/frigidaire-vs-ge-dehumidifier", description: "Head-to-head comparison with the GE 45-pint" }
]} />
