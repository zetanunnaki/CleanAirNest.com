...
<SpecTable specs={[
  ...
  {label: "Tank Size", value: "7.6 pints"},
  {label: "Noise Level", value: "48 dB"},
  {label: "Price", value: "$229.99"}
]} />
...
<VerdictBox 
  verdict="The Tosot 50-Pint is the best value dehumidifier for basements. The built-in pump eliminates the need for an external condensate pump, and the $229.99 price undercuts competitors that charge more for less functionality."
  product="Tosot 50-Pint Dehumidifier with Internal Pump"
  rating="4.4"
  pros={["Built-in pump drains upward to sinks or windows", "Energy Star certified", "Auto defrost for cold basements", "Continuous drain option included", "Competitive price for pump model"]}
  cons={["Pump can be audible when running", "No Wi-Fi or app control", "Bucket is small for 50-pint capacity", "Basic digital controls"]}
/>
