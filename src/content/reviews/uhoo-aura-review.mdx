...
description: "The uHoo Aura has been discontinued. We recommend the Airthings 2930 Wave Plus ($235) as the best replacement — radon, CO2, and VOC monitoring in one battery-powered device."
...
<SourceCitation sources={[
  ...
  {name: "Airthings 2930 Wave Plus", url: "https://www.airthings.com/wave-plus", detail: "Official product page for the recommended uHoo Aura replacement with radon and CO2 sensors"}
]} />
...
<FAQ questions={[
  ...
  {q: "What is the best uHoo Aura replacement?", a: "The Airthings 2930 Wave Plus ($234.99) is the best replacement. It monitors radon, CO2, VOCs, temperature, humidity, and air pressure — all battery-powered with no subscription required."},
...
<InternalLinks links={[
  ...
  {title: "Aranet4 Home (Awair Replacement)", href: "/reviews/awair-element-review", description: "Gold-standard CO2 monitor with 2+ year battery life"},
