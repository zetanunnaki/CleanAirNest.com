...
<SpecTable specs={[
  {label: "Sensors", value: "PM2.5, PM1, PM10, CO2, TVOC, CO, NO2, O3, Temp, Humidity, Air Pressure"},
...
<VerdictBox 
  verdict="The uHoo Aura is the most comprehensive air quality monitor available to consumers. The NO2 and ozone sensors provide genuinely useful data that no competitor offers."
  product="uHoo Aura Smart Air Quality Sensor"
  rating="4.4"
  pros={["11 sensors — most comprehensive monitor available", "Detects NO2, ozone, and CO (uncommon in consumer monitors)", "IFTTT integration triggers purifiers automatically", "Detailed app with personalized health tips"]}
  cons={["Expensive for a monitor", "No standalone display — app only", "Subscription for advanced analytics", "Wi-Fi only, no Bluetooth"]}
/>
...
<InternalLinks links={[
  ...
  {title: "Formaldehyde in Your Home", href: "/guides/formaldehyde-in-your-home", description: "Why the uHoo formaldehyde sensor matters"}
]} />
